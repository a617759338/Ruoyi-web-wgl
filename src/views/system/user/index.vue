        ...
        <pane size="84">
          <el-col>
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="用户工号" align="center" key="workCode" prop="workCode" v-if="columns.workCode.visible" />
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="用户工号" prop="workCode">
              <el-input v-model="form.workCode" placeholder="请输入用户工号" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
const data = reactive({
  ...
  rules: {
    ...
    nickName: [{ required: true, message: "用户昵称不能为空", trigger: "blur" }],workCode: [{ required: true, message: "用户工号不能为空", trigger: "blur" }],
